  <div id="BottomNav" class="relative flex w-full h-[138px] shrink-0">
            <nav class="fixed bottom-5 w-full max-w-[640px] px-5 z-10">
                <div class="grid grid-cols-4 h-fit rounded-[40px] justify-between py-4 px-5 bg-ngekos-black">
                    <a href="<?php echo e(route('home')); ?>" class="flex flex-col items-center text-center gap-2">
                    ...
                    <a href="<?php echo e(route('check-booking')); ?>" class="flex flex-col items-center text-center gap-2">
                    ...
                    <a href="<?php echo e(route('find-kos')); ?>" class="flex flex-col items-center text-center gap-2">
        ...
        </div><?php /**PATH C:\Users\MSI\ngekost\resources\views/includes/navigation.blade.php ENDPATH**/ ?>