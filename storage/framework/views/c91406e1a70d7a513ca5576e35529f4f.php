            ...
            <div class="flex flex-col w-full rounded-[30px] border border-[#F1F2F6] p-4 gap-4 bg-white">
                ...
                <div class="flex gap-4">
                    ...
                    <div class="flex flex-col gap-3 w-full">
                        ...
                        <hr class="border-[#F1F2F6]">
                        <p class="font-semibold text-lg text-ngekos-orange">Rp <?php echo e(number_format($transaction->room->price_per_month, 0, ',', '.')); ?><span
        ...
        <div class="accordion group flex flex-col rounded-[30px] p-5 bg-[#F5F6F8] mx-5 mt-5 overflow-hidden has-[:checked]:!h-[68px] transition-all duration-300">
            ...
            <div class="flex flex-col gap-4 pt-[22px]">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <p class="font-semibold">
                        <?php echo e(\Carbon\Carbon::parse($transaction['start_date'])->addMonths(intval($transaction->duration))->isoformat('D MMMM YYYY')); ?>
        ...
        <div class="accordion group flex flex-col rounded-[30px] p-5 bg-[#F5F6F8] mx-5 mt-5 overflow-hidden has-[:checked]:!h-[68px] transition-all duration-300">
            ...
            <div class="flex flex-col gap-4 pt-[22px]">
                <div class="flex items-center justify-between">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($transaction->payment_method === "full_payment"): ?>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <p class="font-semibold"><?php echo e(number_format($transaction->room->price_per_month,0, ',', '.')); ?></p>
                </div>
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        <img src="assets/images/icons/receipt-2.svg" class="w-6 h-6 flex shrink-0" alt="icon">
                    ...
                    <p class="font-semibold"><?php echo e(number_format($subtotal, 0, ',', '.')); ?></p>
                </div>
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                    ...
                    <p class="font-semibold"><?php echo e(number_format($tax, 0, ',', '.')); ?></p>
                </div>
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                    ...
                    <p class="font-semibold"><?php echo e(number_format($insurance, 0, ',', '.')); ?></p>
                </div>
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                   ...
                   <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($transaction->payment_method == 'full_payment'): ?>
<p class="font-semibold"><?php echo e(number_format($total, 0, ',', '.')); ?></p>
<?php else: ?>
<p class="font-semibold"><?php echo e(number_format($downpayment, 0, ',', '.')); ?></p>
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($transaction->payment_status === 'pending'): ?>
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
