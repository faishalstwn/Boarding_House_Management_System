...
<a href="<?php echo e(route('kos.show', $boardingHouse->slug)); ?>"                class="w-12 h-12 flex items-center justify-center shrink-0 rounded-full overflow-hidden bg-white">
        ...
        <div id="Header" class="relative flex items-center justify-between gap-2 px-5 mt-[18px]">
            <div class="flex w-full rounded-[30px] border border-[#F1F2F6] p-4 gap-4 bg-white">
                ...
                <div class="flex flex-col gap-3 w-full">
                    <h1 class="font-semibold text-lg leading-[27px] line-clamp-2 min-h-[54px]"><?php echo e($boardingHouse->name); ?></h1>
        ...
        <form action="<?php echo e(route('booking', $boardingHouse->slug)); ?>" class="relative flex flex-col gap-4 mt-5" method="POST">
            <?php echo csrf_field(); ?>
            <input type="hidden" name="boarding_house_id" value="<?php echo e($boardingHouse->id); ?>">
            ...
            <div id="RoomsContainer" class="flex flex-col gap-4 px-5">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $boardingHouse->rooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                  <label class="relative group">
                    <input type="radio" name="room" class="absolute top-1/2 left-1/2 -z-10 opacity-0" value="<?php echo e($room->id); ?>" required>
                    <div
                        ...
                        <div class="flex w-[120px] h-[156px] shrink-0 rounded-[30px] bg-[#D9D9D9] overflow-hidden">
                            <img src="<?php echo e(asset('storage/' . $room->images->first()->image)); ?>" class="w-full h-full object-cover"
                                alt="icon">
                        </div>
                        <div class="flex flex-col gap-3 w-full">
                            <h3 class="font-semibold text-lg leading-[27px]"><?php echo e($room->name); ?></h3>
                            <hr class="border-[#F1F2F6]">
                            <div class="flex items-center gap-[6px]">
                                <img src="<?php echo e(asset('assets/images/icons/profile-2user.svg')); ?>" class="w-5 h-5 flex shrink-0"
                                    alt="icon">
