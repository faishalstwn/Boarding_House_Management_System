 ...
 <div id="Background"
        ...
        <div
            ...
            <label class="relative flex items-center justify-between">
                ...
                <img src="<?php echo e(asset('assets/images/icons/arrow-up.svg')); ?>"
            ...
            <div class="flex flex-col gap-4 pt-[22px]">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        <img src="<?php echo e(asset('assets/images/icons/profile-2user.svg')); ?>" class="w-6 h-6 flex shrink-0" alt="icon">
                        <p class="text-ngekos-grey">Name</p>
                    </div>
                    <p class="font-semibold"><?php echo e($transaction['name']); ?></p>
                </div>
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        <img src="<?php echo e(asset('assets/images/icons/sms.svg')); ?>" class="w-6 h-6 flex shrink-0" alt="icon">
                        <p class="text-ngekos-grey">Email</p>
                    </div>
                    <p class="font-semibold"><?php echo e($transaction['email']); ?></p>
                </div>
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        <img src="<?php echo e(asset('assets/images/icons/call.svg')); ?>" class="w-6 h-6 flex shrink-0" alt="icon">
                        <p class="text-ngekos-grey">Phone</p>
                    </div>
                    <p class="font-semibold"><?php echo e($transaction['phone_number']); ?></p>
                </div>
            </div>
        </div>
        <div
            ...
            <div class="flex flex-col gap-4 pt-[22px]">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        <img src="<?php echo e(asset('assets/images/icons/clock.svg')); ?>" class="w-6 h-6 flex shrink-0" alt="icon">
                        <p class="text-ngekos-grey">Duration</p>
                    </div>
                    <p class="font-semibold"><?php echo e($transaction['duration']); ?> Months</p>
                </div>
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                    ...
                    <p class="font-semibold"><?php echo e(\Carbon\Carbon::parse($transaction['start_date'])->isoformat('D MMMM YYYY')); ?></p>
                </div>
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        <img src="/assets/images/icons/calendar.svg" class="w-6 h-6 flex shrink-0" alt="icon">
                    ...
                    <p class="font-semibold"><?php echo e(\Carbon\Carbon::parse($transaction['start_date'])->addMonths(intval($transaction['duration']))->isoformat('D MMMM YYYY')); ?></p>
                </div>
            </div>
        </div>
        <form action="<?php echo e(route('booking.payment', $boardingHouse->slug)); ?>" class="relative flex flex-col gap-6 mt-5 pt-5" method="POST">
            <?php echo csrf_field(); ?>
            <div id="PaymentOptions" class="flex flex-col rounded-[30px] border border-[#F1F2F6] p-5 gap-4 mx-5">
                <div id="TabButton-Container"
                    ...
                    <label class="tab-link group relative flex flex-col justify-between gap-4"
                        ...
                        <div class="flex items-center gap-3 mx-auto">
                            <div class="relative w-6 h-6">
                                <img src="<?php echo e(asset('assets/images/icons/status-orange.svg')); ?>"
                                    class="absolute w-6 h-6 flex shrink-0 opacity-0 group-has-[:checked]:opacity-100 transition-all duration-300"
                                    alt="icon">
                                <img src="<?php echo e(asset('assets/images/icons/status.svg')); ?>"
                    ...
                    <label class="tab-link group relative flex flex-col justify-between gap-4"
                        ...
                        <div class="flex items-center gap-3 mx-auto">
                            <div class="relative w-6 h-6">
                                <img src="<?php echo e(asset('assets/images/icons/diamonds-orange.svg')); ?>"
                                    class="absolute w-6 h-6 flex shrink-0 opacity-0 group-has-[:checked]:opacity-100 transition-all duration-300"
                                    alt="icon">
                                <img src="<?php echo e(asset('assets/images/icons/diamonds.svg')); ?>"
                ...
                <div id="TabContent-Container">
                    ...
                    <div id="DownPayment-Tab" class="tab-content flex flex-col gap-4">
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                <img src="<?php echo e(asset('assets/images/icons/card-tick.svg')); ?>" class="w-6 h-6 flex shrink-0" alt="icon">
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                <img src="<?php echo e(asset('assets/images/icons/receipt-2.svg')); ?>" class="w-6 h-6 flex shrink-0" alt="icon">
                                <p class="text-ngekos-grey">Sub Total</p>
                            </div>
                            <p class="font-semibold">Rp <?php echo e(number_format($subtotal, 0, ',', '.')); ?></p>
                        </div>
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                <img src="<?php echo e(asset('assets/images/icons/receipt-disscount.svg')); ?>" class="w-6 h-6 flex shrink-0"
                                    alt="icon">
                                <p class="text-ngekos-grey">PPN 11%</p>
                            </div>
                            <p class="font-semibold">Rp <?php echo e(number_format($tax, 0, ',', '.')); ?></p>
                        </div>
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                <img src="<?php echo e(asset('assets/images/icons/security-user.svg')); ?>" class="w-6 h-6 flex shrink-0"
                                    alt="icon">
                                <p class="text-ngekos-grey">Insurance</p>
                            </div>
                            <p class="font-semibold">Rp <?php echo e(number_format($insurance, 0, ',',',' )); ?></p>
                        </div>
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                <img src="<?php echo e(asset('assets/images/icons/receipt-text.svg')); ?>" class="w-6 h-6 flex shrink-0"
                                    alt="icon">
                                <p class="text-ngekos-grey">Grand total (30%)</p>
                            </div>
                            <p id="downPaymentPrice" class="font-semibold">Rp <?php echo e(number_format($downpayment, 0, ',', '.')); ?></p>
                        </div>
                    </div>
                    <div id="FullPayment-Tab" class="tab-content flex flex-col gap-4 hidden">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <p id="fullPaymentPrice" class="font-semibold">Rp <?php echo e(number_format($total, 0, ',', '.')); ?></p>
                        </div>
                    </div>
                </div>
            </div>
